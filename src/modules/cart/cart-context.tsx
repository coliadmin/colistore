  ...
  return (
    <CartContext.Provider value={{state, actions}}>
      <>
        {children}
        {Boolean(quantity) && (
          <div className="sticky bottom-0 z-50 flex content-center items-center pb-4 sm:m-auto">
            <Button
              aria-label="Ver pedido"
              className="m-auto mx-2 w-full bg-muted shadow-lg backdrop-blur sm:w-full"
                  ...
                  <ul className="mt-4 flex flex-col gap-4">
                    {items.map((item) => (
                      <>
                        ...
                        >
                          <div className="ml-1 flex w-full justify-between gap-2">
                            ...
                            <div className="flex flex-col justify-end gap-1">
                              {paymentMethod === PaymentMethod.EFECTIVO ? (
                                <div className="flex justify-end gap-2">
                                  <p className="text-md place-self-end font-semibold text-green-600">
                                    $
                                    {Math.round(
                                ...
                                <p className="text-md place-self-end font-semibold">
                                  $
                                  {Math.round(
                                    item.listPrice * item.quantity * (1 - item.discount / 100),
                                  )}
